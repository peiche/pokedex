            ...
            <div className="hidden md:block relative" ref={searchRef}>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-64 pl-10 pr-4 py-2 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-white"
