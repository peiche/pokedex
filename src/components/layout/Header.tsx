...
export const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-border-light dark:border-gray-700">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex gap-5">
            ...
            <div className="hidden md:block relative" ref={searchRef}>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-64 pl-10 pr-4 py-2 bg-gray-100 dark:bg-gray-800 border border-border-light dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-border-light-focus dark:text-white"
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={toggleTheme}
                className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors border border-border-light dark:border-gray-700"
              ...
              <button
                className="md:hidden p-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors border border-border-light dark:border-gray-700"
              ...
              <div className="pt-2">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Search Pokémon..."
                    className="w-full pl-10 pr-4 py-2 bg-gray-100 dark:bg-gray-800 border border-border-light dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-border-light-focus dark:text-white"
                    onChange={handleSearchChange}
                  />
                </div>
              </div>
